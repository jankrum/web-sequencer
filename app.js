...
const controllers = Object.fromEntries(partNames.map(part => [part, new Controller(mediator, part)]));
...
controllers.foreach(controller => controller.start(controllerSectionDiv));
